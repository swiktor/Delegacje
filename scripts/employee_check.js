...
function miejscowosc_check()
{

if (document.getElementById('miejscowosc').value.length !=0)
{
  document.getElementById('miejscowosc2').disabled=true;
}

if (document.getElementById('miejscowosc2').value.length !=0)
{
  document.getElementById('miejscowosc').disabled=true;
}


  if ((document.getElementById('miejscowosc2').value.length !=0 && reg_duze_male_pl.test(document.getElementById('miejscowosc2').value)) || document.getElementById('miejscowosc').value.length !=0)
  {
    miejscowosc_status = true;
  }
  else
  {
    miejscowosc_status = false;
    document.getElementById('add').disabled=true;
    alert("Sprawdź poprawność miejscowości");
  }
}
...
function turnon()
{
  ...
  if (imie_status && nazwisko_status && PESEL_status && miejscowosc_status && telefon_status && data_zatrudnienia_status && mail_status)
  {
